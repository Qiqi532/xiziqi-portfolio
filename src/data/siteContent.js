...
export const profile = {
  ...
  role: '学生 · 摄影爱好者 · 独立开发者',
  statement: '我拍下光，也想知道它从哪里来。',
  introduction: '2023 年进入中山大学，2027 年将赴南京大学继续深造。两所学校都肇始于二十世纪初，也都把基础学科放在核心位置。我在两座校园里读书，在校园媒体与志愿服务里做事，也用相机收下沿途的光。',
...
export const education = [
  {
    ...
    note: '1924 年由孙中山先生亲手创办，初名国立广东大学，1926 年改称国立中山大学。广州南校园「康乐园」以红砖绿瓦的近代建筑群闻名，如今是广州、珠海、深圳三校区五校园的综合性大学。',
    rankings: [
  ...
  },
  {
    ...
    discipline: { label: '教育部第五轮学科评估', subject: '物理学', grade: 'A+' },
    note: '前身可追溯至 1902 年的三江师范学堂，1928 年定名国立中央大学，1950 年改称南京大学。鼓楼校区的北大楼是标志性建筑，学校以基础学科见长，理科与人文的积淀都很深。',
    rankings: [
...
export const researchProjects = [
  {
    ...
    summary: '为同时读出海水温度与盐度，设计并实现基于 SMF–HCF–CF 微球腔的光纤 Fabry–Perot 传感结构。',
    details: ['梳理光纤传感理论，参与传感结构设计与光场仿真。', '用理论推导与函数反演验证温度—盐度同步传感的可行性。', '编写光谱解调仪控制程序，打通数据采集与信号解读。'],
  ...
  },
  {
    ...
    summary: '从 LAMOST DR13 光谱出发，结合物理特征与机器学习方法，筛选化学丰度异常的恒星。',
    details: ['研读氮增丰场星相关文献，建立光谱标准预处理流程。', '从物理特征与机器学习两条线索做分类筛选。', '下一步引入深度学习，推进异常恒星的识别与物理分析。'],
  ...
  },
  {
    ...
    summary: '为个人物理阅读做的可解释 AI 论文情报平台：聚合公开论文事实，用可切换的大模型做保守分类与结构化解读，再以确定性、可解释的兴趣评分生成 Today Physics。',
  ...
  },
  {
    ...
    summary: '本地 AI 智能选片工具，把摄影师的初筛时间还给拍摄：废片剔除 → 相似分组 → 场景自适应评分 → 最佳帧推荐 → 不确定项人工甄选，一键导出保留片。照片全程本地处理、不上传，桌面界面基于 PyQt6，算法核心为纯 Python。',
  ...
  {
    id: 'tesla-scene-studio', label: 'R-05', title: 'Tesla Model 3 · 个人车模仿真项目', period: '2026.09', status: '在线演示',
    summary: '一个自发完成的个人车模仿真项目：用纯静态网页还原 Tesla 2018 Model 3，可在影棚与循环道路两套场景间切换，并在道路上叠加四季 × 五种天气的环境矩阵；车窗、车门、前后备箱、灯光、档位与外观既可直接点击车身，也可用中文语音或文字指令控制。',
    details: ['不引入框架与动画库，用 Vite + 原生 JavaScript + Three.js 搭出三层结构：中文指令先解析成标准命令对象，再经统一分发器进入车辆与环境控制器，按钮、车身点击、语音与文字四条入口共用同一套状态机。', '车辆控制覆盖四门与前后备箱铰链、灯光（刹车灯与倒车灯随档位和车速自动联动）、P/D/R 档位与视觉速度、五种车漆与三种轮毂；车门未关闭时拒绝挂档，行驶中锁定车门与备箱，D 与 R 换向须先停车。', '语音链路三级降级：浏览器本机中文语言包 → 浏览器语音服务 → 按需加载浏览器端 Whisper tiny；支持用“然后 / 再”串联多条指令，歧义指令不猜测执行，文字输入始终可用，且不保存录音与转写历史。', '工程侧包含 49 个单元测试与构建前的 GLB 校验（16 个必需节点 / 14 个必需材质）；车模沿用 Ameer Studio 的 CC BY 4.0 授权，并在页面常驻署名。选题、建模校验与交互逻辑均由个人独立完成。'],
    contribution: '个人项目 · 独立开发 · 源文件 5,140 行 · 纯前端静态部署',
...
export const skillGroups = [
  { label: '计算与建模', items: ['Python', 'PyTorch'] },
  { label: '仿真与测量', items: ['COMSOL', 'Origin', '光谱数据处理'] },
  { label: '工程制图', items: ['SolidWorks', 'AutoCAD'] },
  { label: '论文与写作', items: ['LaTeX', 'Microsoft Office'] },
  { label: 'AI 协作开发', items: ['Codex', 'Claude', 'Vibe Coding'] },
  { label: '影像与后期', items: ['Photoshop', 'Lightroom', 'Camera Raw', 'Premiere Pro', 'Nikon Z5 微单摄影', '无人机航拍'] },
];

export const practiceChapters = [
  {
    label: 'P-01', title: '校园传播与媒体采用',
    summary: '用影像记录校园、学术现场与公共议题，让照片走到更多读者面前。',
  ...
  },
  {
    ...
    summary: '在大型赛事的现场做事，和一群人把同一件事稳稳地做完。',
  ...
  },
  {
    ...
    summary: '在田野与社区里用影像做事，记录手艺与人之间的联系。',
...
export const photography = {
  lead: '在校园、城市与旅途之间持续按下快门，留意光线、空间与人的关系。长期拍校园日常、城市风光与人像三类题材，作品见于《光明日报》与「中国国家旅游」，现为视觉中国、海丝泉州签约摄影师。',
  social: '同时以「曦熙子柒」在小红书更新摄影与旅行内容，写校园生活、摄影攻略与旅途见闻，累计收获 1.8 万+ 获赞与收藏。',
  highlights: [
    { value: '签约摄影师', note: '视觉中国 · 海丝泉州' },
    { value: '1.8 万+ 获赞与收藏', note: '小红书「曦熙子柒」' },
    { value: '长期题材', note: '校园日常 / 城市与远方 / 人与片刻' },
  ],
